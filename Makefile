...
run: maze_solver bfs_solver dfs_solver dijkstra_solver src/main.cpp
	g++ $(FLAGS) src/main.cpp bin/maze_solver.o bin/bfs_solver.o bin/dfs_solver.o bin/dijkstra_solver.o -o run
